          ...
          {user ? (
            <>
              ...
              <button
                ...
                className="px-4 py-2 cursor-pointer text-sm font-medium text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors duration-150 ease-in-out"
              >
                Logout
              </button>
            </>
